...
val arbitrary_payload : int -> Frenetic_Packet.bytes arbitrary
val arbitrary_arp : Frenetic_Packet.Arp.t arbitrary

val arbitrary_udp : Frenetic_Packet.bytes arbitrary -> Frenetic_Packet.Udp.t arbitrary
val arbitrary_tcp : Frenetic_Packet.bytes arbitrary -> Frenetic_Packet.Tcp.t arbitrary
