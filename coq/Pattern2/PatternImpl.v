...
Module Make (Port : PORT) <: PATTERN.
  ...
  Section Constructors.
    ...
    Definition tpSrcPort proto tpPort : t :=
      Pattern
        WildcardAll
        WildcardAll
        (WildcardExact NetworkPacket.Const_0x800)
    ...
    Definition tpDstPort proto tpPort : t :=
      Pattern
        WildcardAll
        WildcardAll
        (WildcardExact NetworkPacket.Const_0x800)
    ...
    Definition tcpSrcPort := tpSrcPort NetworkPacket.Const_0x6.

    Definition tcpDstPort := tpDstPort NetworkPacket.Const_0x6.

    Definition udpSrcPort := tpSrcPort NetworkPacket.Const_0x7.

    Definition udpDstPort := tpDstPort NetworkPacket.Const_0x7.
