...
Fixpoint match_pred (pr : Pred) (sw : switchId) (pt : portId) (pk : packet) := 
  ...
  Fixpoint compile_pred (opt : Classifier bool -> Classifier bool) (pr : Pred) (sw : switchId) : Classifier bool := 
    match pr with
      | PrHdr pat => [(pat, true)]
      | PrOnSwitch sw' => 
      ...
      | PrOr pr1 pr2 => opt (union orb (compile_pred opt pr1 sw) (compile_pred opt pr2 sw))
      | PrNot pr' => 
