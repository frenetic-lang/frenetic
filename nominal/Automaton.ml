open Core
open Frenetic
open Frenetic.Netkat.Local_compiler

module Netkat_Auto = Frenetic.Netkat.Global_compiler.Automaton
...
type edge = int64 * constr list * int
  [@@deriving sexp, yojson]

type finalEdge = int64 * constr list
  [@@deriving sexp, yojson]
...
let normalize_states (auto : Netkat_Auto.t) : Netkat_Auto.t =
  ...
  let state_map : (int64, int64) Hashtbl.t = Int64.Table.create () in
