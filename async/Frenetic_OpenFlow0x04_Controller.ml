...
let implement_flow (writer : Writer.t) (fdd : Frenetic_NetKAT_Local_Compiler.t) 
  (layout : Frenetic_NetKAT_Local_Compiler.flow_layout)
...
let implement_tolerant_flow (writer : Writer.t) (fdd : Frenetic_NetKAT_Local_Compiler.t) 
  (topo : Frenetic_NetKAT_Net.Net.Topology.t) (sw_id : Frenetic_OpenFlow.switchId)
  : unit =
  let open Frenetic_OpenFlow0x04 in
  let flowtable = Frenetic_NetKAT_Local_Compiler.to_table sw_id fdd in
...
let main (of_port : int) (pol_file : string) 
  (layout : Frenetic_NetKAT_Local_Compiler.flow_layout) () : unit =
  let open Frenetic_NetKAT_Local_Compiler in 
