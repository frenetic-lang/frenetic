...
type t
val port_stats: t -> switchId -> portId -> Frenetic_OpenFlow0x01.portStats list Deferred.t

val current_switches: t -> (switchId * portId list) list Deferred.t Deferred.t
