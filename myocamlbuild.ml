(* OASIS_START *)
(* DO NOT EDIT (digest: 1977d528b0f1fb82e40708a267fa6cf5) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_library_frenetic_ccopt"; "compile"],
            [
          ...
          (["oasis_library_frenetic_cclib"; "link"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.ETest ("system", "linux"),
                 S [A "-cclib"; A "-lrt"])
            ]);
          (["oasis_library_frenetic_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S []);
