...
module Pattern : sig
  ...
  *)
  ...
  val to_sdn : t -> Frenetic_std.OpenFlow.Pattern.t -> Frenetic_std.OpenFlow.Pattern.t
end
...
module Action : sig
  ...
  val to_sdn : ?group_tbl:Frenetic_std.GroupTable0x04.t
            -> Int64.t option -> t -> Frenetic_std.OpenFlow.par
