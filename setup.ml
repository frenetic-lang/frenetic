...
(* OASIS_START *)
(* DO NOT EDIT (digest: beebfe73f846b5ad07259036653ac229) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "frenetic";
                           FindlibPackage
                             ("mparser", Some (OASISVersion.VEqual "1.2"));
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\250\024\230K\176\197\183\144\140\238o\197Bs\244(";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
