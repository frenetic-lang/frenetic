...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e45831065f120b1097dbcab6071d8bc) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "firepath.ml"});
               Executable
                 ({
                     cs_name = "p4";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "p4.ml"});
               Library
                 ({
                     cs_name = "syntax";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\241\1407\129\188G\192\168\007q\181si\254\019*";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
