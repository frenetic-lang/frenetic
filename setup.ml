...
(* OASIS_START *)
(* DO NOT EDIT (digest: 82c40aee124322a5b1be88c5dae20b3a) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$probnetkat", []))];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Frenetic_Vlr";
                           "Frenetic_ProbNetKAT";
                           "Frenetic_ProbNetKAT_Interpreter"
                        ];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "frenetic"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\225R\162r`\187\150A\129\238N\201\190\160\t.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
