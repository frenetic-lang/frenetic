...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33d953fdb865c25f9189ba4e03f46b16) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$testtool",
                          ["inline-test-runner"; "frenetic"; "-verbose"]))
                   ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "a\000W\227\250\178\016\137\248\213\018\247^]\0022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
