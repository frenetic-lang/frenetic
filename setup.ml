...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3210a514b4fbfbd262fdc6279c4683ba) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./decide.native", []))];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "probnetkat"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
                   ...
                   {exec_custom = false; exec_main_is = "decide.ml"});
               Test
                 ({
                     cs_name = "decide";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "LoadBalancer.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/prob/apps/te";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "probnetkat";
     ...
     oasis_digest = Some "\163\211F\189g\252\219\2077J\173I\220\176\197\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
