...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1231d612b885393f5846ed0f3a687b48) *)
(*
...
let setup_t =
  {
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Frenetic_OpenFlow0x04_Controller";
                           "Frenetic_NetKAT_Controller";
                           "Frenetic_NetKAT_Controller0x04";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1699\1960V\155\003\151`\128\158\177\1965\221\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
