...
(* OASIS_START *)
(* DO NOT EDIT (digest: 712457efa0d72c80e0bb068c76a7d93d) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            ...
            "-package";
            "ppx_deriving,ppx_deriving.std,ppx_sexp_conv,ppx_fields_conv,ppx_type_conv,ppx_enumerate,ppx_compare"
         ];
     test =
       [
          ("all_tests",
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cstruct",
                               Some (OASISVersion.VGreaterEqual "3.0.2"));
                           ...
                           FindlibPackage ("tcpip.unix", None);
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("core", None);
                           InternalLibrary "frenetic";
                           InternalLibrary "frenetic_async";
     ...
     oasis_digest =
       Some "\170\255\219\142\218\247\002?\139\251\136}\245\147:\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
