...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9bb6a7a953899ac0ee8a7a4e9f0a90ed) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "nominal.ml"})
            ];
     ...
     oasis_digest = Some "v`\1403\011\004,\226*7\233\204\212\020%\155";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
