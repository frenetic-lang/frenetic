...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0ba81b2ab8cfa433178cb0621f763690) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the packet.quickcheck library";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Packet documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\226\028v\229\193\249\224q1\1904O\186M\160\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
