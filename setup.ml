...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25c0da1b7f1c85ad06b5c1c086a6c8d5) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Core"; "Util"; "Parsers"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Topology Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "@\177\244~\0310\200D[\020\254\193\213{\178\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
