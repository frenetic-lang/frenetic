...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a132d52b92bb352be4d03cd2efe1bcb) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Frenetic_Network"; "Frenetic_Topology"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "topology";
     ...
     oasis_digest = Some "\254Sa\228\155Y\025\228\186\026\197\129\248(Cb";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
