...
(* OASIS_START *)
(* DO NOT EDIT (digest: ae4c94e1a375b53eddef5101f438bce0) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cma.ml"});
               Executable
                 ({
                     cs_name = "openflow";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "6\176\031\162\186W\147\233v\129S\173Y\031\200>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
