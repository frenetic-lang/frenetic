...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c702ac3de6c013f06cd2051333bc3cb) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Async_OpenFlow_Log"; "Async_OpenFlow_Platform"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "=\249F+X\129i\155h\208\167\218{\130\007\233";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
