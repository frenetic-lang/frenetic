...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2e37328c31516d049c13c53fbe77b229) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_OpenFlow"; "Async_Highlevel"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Async_OpenFlow_Log";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\193~u\201\179\1394\216\016y\197\135\007\001'`";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
