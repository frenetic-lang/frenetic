...
(* OASIS_START *)
(* DO NOT EDIT (digest: a68d8f13351aac74fb19afc5f607bc02) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Types"; "Node"; "Link"; "Network"];
                      lib_pack = true;
                      lib_internal_modules = ["Util"; "Parsers"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "EC\127\250R\224\155\022a{\184\237U?\148w";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
