...
(* OASIS_START *)
(* DO NOT EDIT (digest: d86ae2a29f265f299647c5b646b4e7f7) *)
(*
...
(* # 22 "/var/tmp/portage/dev-ml/oasis-0.4.1/work/oasis-0.4.1/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("netkat_decide", None);
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some ",\251!\170k\000\014q\220\142\166b\2444\155\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
