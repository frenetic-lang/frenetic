...
(* OASIS_START *)
(* DO NOT EDIT (digest: f283e3d3bd66e3248f442efe30870cfb) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["DOT_Types"; "Topology"; "DOT_Parser"];
                      lib_pack = false;
                      lib_internal_modules = ["Util"; "Lexer"; "Parser"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Ñob}ê\001ú¼?\159B>gg\143¢";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
