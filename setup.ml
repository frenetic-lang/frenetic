...
(* OASIS_START *)
(* DO NOT EDIT (digest: a583d0dd2897c233fc39f5002ac41727) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lb.ml"})
            ];
     ...
     oasis_digest = Some "7R\217\1412\209\211\229\172\229o\226%\029M\249";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
