...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9fb271c58f7ca6401d36b0b1eb141c9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the netcore.lwt library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\204\208\214\139\201]\140\017^i\162&BX\t\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
