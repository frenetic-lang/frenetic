...
(* OASIS_START *)
(* DO NOT EDIT (digest: ec910a7cdf2de961110b17bf639d36ec) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            ...
            "-package";
            "ppx_deriving,ppx_deriving.std,ppx_sexp_conv,ppx_fields_conv,ppx_type_conv,ppx_enumerate,ppx_compare,ppx_hash"
         ];
     test = [];
     doc = [];
     ...
     oasis_digest =
       Some "\228\001\200:\163\181w\215D\211\024\135\188\012\190\228";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
