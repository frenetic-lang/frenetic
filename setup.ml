...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4cf5140a30481978e00531db228704f1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          beta_features = ["findlib_extra_files"; "findlib_directory"];
          name = "frenetic";
          license_file = None;
          copyrights = [];
          maintainers = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["LexBuffer"; "New_Lexer"; "PPX_NetKAT"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      ...
                      Some
                        (("cppo",
                           [
                              ...
                              "\\\n";
                              "-o";
                              "lib/Frenetic_NetKAT_Parser.mly\ncppo";
                              "-n";
                              "\\\n";
                              "ppx/Frenetic_NetKAT_PPX_Parser.cppo.mly";
                              "\\\n";
                              "-o";
                              "ppx/Frenetic_NetKAT_PPX_Parser.mly\nmenhir";
                              "--only-tokens";
                              "lib/Frenetic_NetKAT_Parser.mly";
                              "\\\n";
                              "--base";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\023\143\169_\164\021\204~?N.\248\188\159d\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
