...
(* OASIS_START *)
(* DO NOT EDIT (digest: 50bfd5452e4014fe1f431e74155dd731) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Bits"; "OpenFlow_Misc"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_OpenFlow0x01_Controller"];
                      lib_pack = false;
                      lib_internal_modules = ["Async_OpenFlow_Log"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ิ\146~I\158ขา\025ื[\018\\ุ\132\131ๆ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
