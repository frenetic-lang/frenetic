...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e2e50d103a7a6115a604a233fb26b7e) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-use-menhir"; "-cflags"; "-w,-40,-short-paths"];
     test = [];
     doc = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["LexBuffer"; "New_Lexer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      ...
                      Some
                        (("cppo",
                           [
                              ...
                              "\\\n";
                              "-o";
                              "syntax/Frenetic_NetKAT_PPX_Parser.mly"
                           ])))
                 ];
               post_command =
                 [
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\211\\!t\128\255\147\149\243\140\1642\163\228\158o";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
